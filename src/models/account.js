...
//글로벌 변수 접근이라서 오버라이드가 안된다고 에러를 표출 밑에와 같이 에러를 피함
// module.exports = mongoose.model("Account", Account);

// var Acc = mongoose.model('Account', Account);
// module.exports = Acc;
// var Acc;
// if (mongoose.models.Account) {
//   Acc = mongoose.model('Account');
// } else {
//   Acc = mongoose.model('Account', Account);
// }

// module.exports = mongoose.model('Account', Account);
var acc = mongoose.models.Account || mongoose.model("Account", Account);
module.exports = acc;
// module.exports = mongoose.model("Account", Account);
